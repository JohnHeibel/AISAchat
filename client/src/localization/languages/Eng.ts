...
export default {
  ...
  com_auth_email: 'Email (uoregon.edu)',
  com_auth_email_required: 'Oregon email is required',
  ...
  com_auth_email_pattern: 'You must enter a valid email University of Oregon address',
  com_auth_email_address: 'uoregon.edu email address',
